...
def global_changes():
    ...
    global number # обхъявляем переменную number глобальной
    global string # обхъявляем переменную string глобальной
    number = 5 # присваиваем новое значение переменной number
    string = 'Hello, dear friend' # присваиваем новое значение переменной string
