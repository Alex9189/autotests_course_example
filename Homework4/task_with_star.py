...
def max_division_by_3(num):
    ...
    for i in range(len(num_str)):
        for j in range(10):
            new_num_str = num_str[:i] + str(j) + num_str[i + 1:]  # заменяем i-ую цифру на j
            new_num1 = int(new_num_str)  # преобразуем обратно в число
            if new_num1 % 3 == 0 and new_num1 > new_num: # проверяем выполнение условий
                new_num = new_num1
    return new_num
