...
def create_phone_number(num_tuple):
    ...
    str_phone = '(' + str(num_tuple[0]) + str(num_tuple[1]) + str(num_tuple[2]) + ') ' + str(num_tuple[3]) + str(
        num_tuple[4]) + str(num_tuple[5]) + '-' + str(num_tuple[6]) + str(num_tuple[7]) + str(num_tuple[8]) + str(
        num_tuple[9])
    return str_phone
