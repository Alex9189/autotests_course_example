...
def letter_stat(our_str):
    ...
    letters_dict = {} # создаем пустой словарь, в котором будет содержаться количество вхождений каждой буквы в строку
    for letter in our_str: # итерируемся по каждой букве в строке our_str
        if letter in letters_dict: # Если буква уже есть в словаре "letters_dict"
            letters_dict[letter] += 1 # то ее значение увеличивается на 1
        else: # если буквы нет
            letters_dict[letter] = 1 # то она добавляется в словарь со значением 1
